...
public static void main(java.lang.String[] args) {
	...
	//	x.checkState(PROCESSXSLT, x.processxslt);
		...
		sheet = props.getProperty(XMLDBMSProps.XSLTSCRIPT);
		xmlfile = props.getProperty(XMLDBMSProps.XMLFILE);
		outputfile = props.getProperty(XMLDBMSProps.XSLTOUTPUT);
...
//		System.out.println("XMLFile = " +xmlfile);
	...
	private ProcessXslt processxslt;	private static String PROCESSXSLT = "ProcessXslt";                  
