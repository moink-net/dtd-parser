...
// Changed Admingui to XMLDBMS throughout

import de.tudarmstadt.ito.xmldbms.tools.*;
 
public class XMLDBMS extends javax.swing.JFrame {
...
class IvjEventHandler implements javax.swing.event.ChangeListener {
		public void stateChanged(javax.swing.event.ChangeEvent e) {
			if (e.getSource() == XMLDBMS.this.getJTabbedPane1()) 
				connEtoM7(e);
		};
	};
	IvjEventHandler ivjEventHandler = new IvjEventHandler();
/**
 * XMLDBMS constructor comment.
 */
public XMLDBMS() {
	super();
	initialize();
 ...
 */
public XMLDBMS(String title) {
	super(title);
}
/**
 * connEtoM1:  (XMLDBMS.initialize() --> BasicPanelFactory.BasicPanel())
...
/**
 * connEtoM2:  ( (XMLDBMS,initialize() --> BasicPanelFactory,BasicPanel()).normalResult --> BasicPanel1.this)
...
/**
 * connEtoM3:  (XMLDBMS.initialize() --> Page.add(Ljava.awt.Component;)Ljava.awt.Component;)
...
/**
 * connEtoM4:  (XMLDBMS.initialize() --> ActionPanelFactory.ActionPanel())
...
/**
 * connEtoM5:  ( (XMLDBMS,initialize() --> ActionPanelFactory,ActionPanel()).normalResult --> ActionPanelObject.this)
...
/**
 * connEtoM6:  (XMLDBMS.initialize() --> JPanel1.add(Ljava.awt.Component;)Ljava.awt.Component;)
 * @return java.awt.Component
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
...
/**
 * connEtoM7:  (JTabbedPane1.change.stateChanged(javax.swing.event.ChangeEvent) --> XMLDBMS.refresh()V)
...
public static void main(java.lang.String[] args) {
	try {
		XMLDBMS aXMLDBMS;
		aXMLDBMS = new XMLDBMS();
		aXMLDBMS.addWindowListener(new java.awt.event.WindowAdapter() {
			public void windowClosing(java.awt.event.WindowEvent e) {
				System.exit(0);
			};
		});
		aXMLDBMS.show();
		java.awt.Insets insets = aXMLDBMS.getInsets();
			// 3/23/2001, Ronald Bourret
			// Commented out the following line. The methods getWidth and
			// getHeight are not supported in Swing 1.1.1
//		aXMLDBMS.setSize(aXMLDBMS.getWidth() + insets.left + insets.right, aXMLDBMS.getHeight() + insets.top + insets.bottom);
		aXMLDBMS.setVisible(true);
