...
public class SubsetToDTD
{
   ...
   //
   // Note that this code generally assumes the DTD to be syntactically
   // correct; results are undetermined if it is not.

   // ********************************************************************
   // Constants
   // ********************************************************************

   // Note that READER_READER simply means we don't care what type of Reader
	...
	*/
   public DTD convertDocument(InputSource src, Hashtable namespaceURIs)
	...
	* @exception IOException Thrown if an I/O error occurs.
	*/
   public DTD convertExternalSubset(InputSource src, Hashtable namespaceURIs)
	  throws DTDException, MalformedURLException, IOException, EOFException
   {
	  initGlobals();
	  this.namespaceURIs = namespaceURIs;
	  ...
	  throws DTDException, MalformedURLException, IOException, EOFException
   {
	  ...
	  root = getName();
	  if (root == null)
		 throwDTDException("Invalid root element type name.");
	  ...
	  throws DTDException, MalformedURLException, IOException, EOFException
   {
	  ...
	  // Get the element type name and add it to the DTD.
	  name = getNSName();
   ...
   NSName getNSName()
	  throws DTDException, MalformedURLException, IOException, EOFException
   {
	  // Get the element type name and construct an NSName from it.
	  ...
	  throws DTDException, MalformedURLException, IOException, EOFException
   {
	  ...
	  // Get an ElementType for the referenced child.
	  ...
	  if (mixed)
	  {
		 if (parent.children.containsKey(child.name.qualified))
			throwDTDException("The element type " + child.name.qualified + " appeared more than once in the declaration of mixed content for the element type " + child.name.qualified + ".");
	  }
   ...
   void throwDTDException(String s)
	  throws DTDException
   {
	  throw new DTDException(s + " Line: " + line + " Column: " + column);
   }   
	  ...
	  throws DTDException, MalformedURLException, IOException, EOFException
   {
	  ...
	  while ((c != quote) || ignoreQuote)
	  {
		 ...
		 {
			if (!ignoreMarkup)
			   throwDTDException("Markup character '" + c + "' not allowed in entity value.");
		 }
		 appendLiteralBuffer(c);
		 c = nextChar();
	  }
	  ...
	  throws DTDException, MalformedURLException, IOException, EOFException
   {
	  ...
	  {
		 if (!isPubidChar(c))
			throwDTDException("Invalid character in public identifier: " + c + ".");
		 appendLiteralBuffer(c);
	  }
	  return getLiteralBuffer();
   }   
	  ...
	  throws DTDException, IOException, EOFException
   {
	  ...
	  if (entity == null)
	  {
		 ...
		 if (entity == null)
			throwDTDException("Reference to undefined parsed general entity: " + entityName + ".");
	  }

	  if (entity.value == null)
		 throwDTDException("Reference to external parsed general entity in attribute value: " + entityName + ".");
	  ...
	  throws DTDException, MalformedURLException, IOException, EOFException
   {
	  ...
	  if (entity == null)
		 throwDTDException("Reference to undefined parameter entity: " + entityName + ".");
